"""
Django settings for white_wave_dev_95414 project.
...
ROOT_URLCONF = 'white_wave_dev_95414.urls'
...
WSGI_APPLICATION = 'white_wave_dev_95414.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_wave_dev_95414 API",
    "DESCRIPTION": "API documentation for white_wave_dev_95414 App",
    "VERSION": "v1",
}
